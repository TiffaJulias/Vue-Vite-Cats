<template>
  <div>
    <h1 style="font-family: 'LibertinusKeyboard'">🐱 cat list</h1>
    ...
    <ul class="bg-black p-4 m-2 rounded-lg ">
    ...
    <p>
      <b v-if="clicked">Filtered to Persian cats:  </b><br>
      <div v-for="cat in persian" :key="cat.image_link" class="list-none text-left bg-black p-4 m-2 rounded-lg hover:shadow-2xl hover:scale-105 hover: cursor-pointer">
